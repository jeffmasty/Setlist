...
public class LoopStory extends SmashHit {
	...
	TimeListener strings = new TimeListener() {
		@Override public void update(Property prop, Object value) {
			...
			looper.getSoloTrack().removeListener(this);
	...
	public void startup() {
		super.startup();
		frame.sheetMusic("LoveStory.png");
		count = 0;
		...
		looper.getSoloTrack().addListener(strings);
	...
	public void teardown() {
		...
		looper.getSoloTrack().removeListener(strings);
	}
